...
# Run 500-claim experiments using GPT-4 moderator with all three helper types
# This script will run 3 times per helper type per claim (4500 total debates)

echo "Starting GPT-4 Moderator Experiments"
echo "====================================="
...
echo "Moderator: GPT-4 (forced, no PALM)"
...
# Run the experiment with forced GPT-4 moderator (API keys read automatically)
python3 main.py \
    --claim_number 499 \
    --num_runs 3 \
    --run_all_helpers \
    ...
    --log_html_path "./debates_gpt4_experiments/" \
    --persuader_instruction "persuader_claim_reason_instruction" \
    --debater_instruction "debater_claim_reason_instruction"

echo ""
echo "GPT-4 Moderator Experiments Completed!"
echo "Results saved to: ./debates_gpt4_experiments/"
echo "Summary statistics: ./debates_gpt4_experiments/comprehensive_statistics.xlsx"
echo ""
