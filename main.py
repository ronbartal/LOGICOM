...
def _run_single_debate(index: int, 
    ...
    try:
        ...
        debater_self_admission_round = run_result_data.get('debater_self_admission_round')
        moderator_conviction_round = run_result_data.get('moderator_conviction_round')
